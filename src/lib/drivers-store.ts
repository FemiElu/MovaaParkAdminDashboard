...
const data: Record<string, Driver[]> = globalThis.__driversData ?? {
  "lekki-phase-1-motor-park": [
    ...
    },
    {
      ...
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      documents: [{ type: "DRIVER_LICENSE", number: "BAY12345CD6" }],
    },
    {
      id: "d_lekk_3",
      parkId: "lekki-phase-1-motor-park",
      ...
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      documents: [{ type: "DRIVER_LICENSE", number: "KAN54321EF7" }],
    },
  ],
  "ikeja-motor-park": [
    {
      ...
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      documents: [{ type: "DRIVER_LICENSE", number: "ENU01234GH8" }],
    },
    {
      id: "d_ikej_2",
      parkId: "ikeja-motor-park",
      ...
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      documents: [{ type: "DRIVER_LICENSE", number: "JOS98765IJ3" }],
    },
    {
      id: "d_ikej_3",
      parkId: "ikeja-motor-park",
      ...
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      documents: [{ type: "DRIVER_LICENSE", number: "PHC34567KL9" }],
    },
    {
      id: "d_ikej_4",
      parkId: "ikeja-motor-park",
      ...
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      documents: [{ type: "DRIVER_LICENSE", number: "IBA76543MN1" }],
    },
  ],
};
